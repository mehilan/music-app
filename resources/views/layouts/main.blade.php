    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative">
                    <input type="text" class="bg-gray-800 focus:outline-none focus:shadow-outline text-sm rounded-full w-64 px-4 pl-8 py-1" placeholder="search">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="">
                        <img src="/img/avatar.jpg" alt="avatar" srcset="" class="rounded-full w-8 h-8">
                    </a>
                </div>
            </div>
        </div>
